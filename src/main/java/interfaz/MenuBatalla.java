...
public class MenuBatalla {
	...
	private static final int [][] botones = { { x + 90, y + 80 } , { x + 90, y + 160 } , { x + 182 , y + 80 } , { x + 182 , y + 160 } , { x + 274 , y + 80 } , { x + 274 , y + 160 },  { x + 366 , y + 80 }, { x + 366 , y + 160 }, { x + 438, y + 80 }, { x + 438 , y + 160 }, { x + 510 , y + 80 }, { x + 510 , y + 160 }, { x + 582 , y + 80 }, { x + 582 , y + 160 }, { x + 654 , y + 80 }, { x + 654 , y + 160 }};
	...
	public void graficar(Graphics g){
		...
		//g.drawImage(Recursos.barraItems, botones[4][0] + 40, botones[4][1], 100, 120, null);
		g.drawImage(Recursos.items.get("Pocion de Salud"), botones[6][0], botones[6][1], anchoBoton, anchoBoton, null);
		g.drawImage(Recursos.items.get("Pocion de Energia"), botones[7][0], botones[7][1], anchoBoton, anchoBoton, null);
		...
		g.drawImage(Recursos.items.get("Pocion de Cansancio"), botones[14][0], botones[14][1], anchoBoton, anchoBoton, null);
